...
namespace SpreadsheetLightWrapper.Core.conditionalformatting
{
    internal class SLIconSet
    {
        ...
        private void SetAllNull()
        {
            ...
            IconSetType = SLIconSetValues.ThreeTrafficLights1;
            ShowValue = true;
            Percent = true;
            Reverse = false;
        }
        ...
        internal void FromIconSet(IconSet ics)
        {
            ...
            if (ics.IconSetValue != null) IconSetType = TranslateIconSetToInternalSet(ics.IconSetValue.Value);
        ...
        {
            var ics2010 = new SLIconSet2010();
            ics2010.IconSetType = TranslateInternalSetToIconSet2010(IconSetType);
            ics2010.ShowValue = ShowValue;
            ics2010.Percent = Percent;
            ics2010.Reverse = Reverse;
        ...
        {
            var result = SLIconSetValues.ThreeTrafficLights1;
            switch (isv)
            {
        ...
        {
            var result = IconSetValues.ThreeTrafficLights1;
            switch (isv)
            {
        ...
        {
            var result = X14.IconSetTypeValues.ThreeTrafficLights1;
            switch (isv)
            {
                case SLIconSetValues.FiveArrows:
        ...
        internal static void TranslateCustomIcon(SLIconValues Icon, out X14.IconSetTypeValues IconSetType,
            out uint IconId)
        {
        ...
        {
            var result = SLIconValues.NoIcon;
            switch (IconSetType)
            {
