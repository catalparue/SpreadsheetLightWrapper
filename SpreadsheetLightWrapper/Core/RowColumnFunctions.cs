...
namespace SpreadsheetLightWrapper.Core
{
    public partial class SLDocument
    {
        ...
        public bool HasRowStyle(int RowIndex)
        {
            ...
            {
                var rp = slws.RowProperties[RowIndex];
                if (rp.StyleIndex > 0)
                    result = true;
            }
        ...
        /// <summary>
        ///     Get the row height. If the row doesn't have a height explicitly set, the default row height for the current
        ...
        {
            var fHeight = slws.SheetFormatProperties.DefaultRowHeight;
            if (slws.RowProperties.ContainsKey(RowIndex))
            {
                var rp = slws.RowProperties[RowIndex];
                if (rp.HasHeight)
        ...
        public bool SetRowHeight(int StartRowIndex, int EndRowIndex, double RowHeight)
        {
            ...
            var result = false;
            if ((iStartRowIndex >= 1) && (iStartRowIndex <= SLConstants.RowLimit) && (iEndRowIndex >= 1) &&
        ...
        {
            AutoFitRow(RowIndex, RowIndex, SLConstants.MaximumRowHeight);
        }
        ...
        {
            AutoFitRow(RowIndex, RowIndex, MaximumRowHeight);
        }
        ...
        {
            AutoFitRow(StartRowIndex, EndRowIndex, SLConstants.MaximumRowHeight);
        }
        ...
        public void AutoFitRow(int StartRowIndex, int EndRowIndex, double MaximumRowHeight)
        {
            ...
            var iMaximumPixelLength = Convert.ToInt32(Math.Floor(MaximumRowHeight/RowHeightMultiple));

            var pixellength = AutoFitRowColumn(true, iStartRowIndex, iEndRowIndex, iMaximumPixelLength);

            var fDefaultRowHeight = slws.SheetFormatProperties.DefaultRowHeight;
            ...
            bool bStrike;
            bool bUnderline;
            var drawstyle = FontStyle.Regular;
            Font ftUsableFont;
            SizeF szf;

            using (var bm = new Bitmap(4096, 2048))
            {
                var fResolution = 96.0;
                        ...
                        if (iPixelLength > 0)
                        {
                            ...
                            if (slws.RowProperties.ContainsKey(pixlenpt))
                            {
                                ...
                                else
                                {
                                    ...
                                    bStrike = false;
                                    bUnderline = false;
                                    drawstyle = FontStyle.Regular;
                                    if (style.fontReal.HasFontScheme)
                                    {
                                        if (style.fontReal.FontScheme == FontSchemeValues.Major)
                                            sFontName = SimpleTheme.MajorLatinFont;
                                        else if (style.fontReal.FontScheme == FontSchemeValues.Minor)
                                            sFontName = SimpleTheme.MinorLatinFont;
                                        else if ((style.fontReal.FontName != null) &&
                                                 (style.fontReal.FontName.Length > 0))
                                            sFontName = style.fontReal.FontName;
                                    }
                                    else
                                    {
                                        if ((style.fontReal.FontName != null) && (style.fontReal.FontName.Length > 0))
                                            sFontName = style.fontReal.FontName;
                                    }
                                    ...
                                    if (bBold) drawstyle |= FontStyle.Bold;
                                    if (bItalic) drawstyle |= FontStyle.Italic;
                                    if (bStrike) drawstyle |= FontStyle.Strikeout;
                                    if (bUnderline) drawstyle |= FontStyle.Underline;

                                    ftUsableFont = SLTool.GetUsableNormalFont(sFontName, fFontSize, drawstyle);

                                    dictAutoFitFontCache[iStyleIndex] = (Font) ftUsableFont.Clone();
                                }
        ...
        /// </summary>
        /// <param name="RowIndex">
        ///     The row index of the row just after the group of rows you want to collapse. For example, this
        ///     will be row 5 if rows 2 to 4 are grouped.
        /// </param>
        ...
        /// </summary>
        /// <param name="RowIndex">
        ///     The row index of the row just after the group of rows you want to expand. For example, this will
        ///     be row 5 if rows 2 to 4 are grouped.
        /// </param>
            ...
            if (slws.RowProperties.ContainsKey(RowIndex))
            {
                ...
                if (rp.Collapsed)
                    ...
                    else
                    {
                        ...
                        var byCurrentOutlineLevel = rp.OutlineLevel;
                        int i;
                        for (i = RowIndex - 1; i >= 1; --i)
                            if (slws.RowProperties.ContainsKey(i))
                            {
        ...
        public bool CopyRow(int StartRowIndex, int EndRowIndex, int AnchorRowIndex, bool ToCut)
        {
                ...
                && (iStartRowIndex != AnchorRowIndex))
            {
                ...
                var diff = AnchorRowIndex - iStartRowIndex;
                var i = 0;
                var rows = new Dictionary<int, SLRowProperties>();
                for (i = iStartRowIndex; i <= iEndRowIndex; ++i)
                    if (slws.RowProperties.ContainsKey(i))
                    {
                ...
                var rowkeys = slws.RowProperties.Keys.ToList();
                foreach (var rkey in rowkeys)
                ...
                foreach (var pt in listCellKeys)
                ...
                listCellKeys = slws.Cells.Keys.ToList();
                foreach (var pt in listCellKeys)
                ...
                {
                    c = cells[key];
                    ProcessCellFormulaDelta(ref c, AnchorRowIndex, iNumberOfRows, -1, 0);
                    slws.Cells[key] = c;
                }
                ...
                foreach (var mc in mca)
                    if ((mc.StartRowIndex >= iStartRowIndex) && (mc.EndRowIndex <= iEndRowIndex))
                    {
                        ...
                        MergeWorksheetCells(mc.StartRowIndex + diff, mc.StartColumnIndex, mc.EndRowIndex + diff,
                            mc.EndColumnIndex);
                    }
                ...
                if (slwb.CalculationCells.Count > 0)
                {
                    ...
                    var iRowLimit = AnchorRowIndex + iStartRowIndex - iEndRowIndex;
                    for (i = 0; i < slwb.CalculationCells.Count; ++i)
                        if (slwb.CalculationCells[i].SheetId == giSelectedWorksheetID)
                        {
                            if (ToCut && (slwb.CalculationCells[i].RowIndex >= iStartRowIndex) &&
                                (slwb.CalculationCells[i].RowIndex <= iEndRowIndex))
                                if (!listToDelete.Contains(i)) listToDelete.Add(i);

                            if ((slwb.CalculationCells[i].RowIndex >= AnchorRowIndex) &&
                                (slwb.CalculationCells[i].RowIndex <= iRowLimit))
                                if (!listToDelete.Contains(i)) listToDelete.Add(i);
                        }
        ...
        public bool InsertRow(int StartRowIndex, int NumberOfRows)
        {
            ...
            if ((StartRowIndex >= 1) && (StartRowIndex <= SLConstants.RowLimit))
            {
                ...
                if (slws.Tables.Count > 0)
                    foreach (var t in slws.Tables)
                    {
                        iRowIndex = t.StartRowIndex;
                        iRowIndex2 = t.EndRowIndex;
                        AddRowColumnIndexDelta(StartRowIndex, NumberOfRows, true, ref iRowIndex, ref iRowIndex2);
                        ...
                        if (t.HasAutoFilter)
                        {
                            ...
                            AddRowColumnIndexDelta(StartRowIndex, NumberOfRows, true, ref iRowIndex, ref iRowIndex2);
                            if ((iRowIndex != t.AutoFilter.StartRowIndex) || (iRowIndex2 != t.AutoFilter.EndRowIndex))
                                t.IsNewTable = true;
                            ...
                            if (t.AutoFilter.HasSortState)
                            {
                                ...
                                AddRowColumnIndexDelta(StartRowIndex, NumberOfRows, true, ref iRowIndex, ref iRowIndex2);
                                if ((iRowIndex != t.AutoFilter.SortState.StartRowIndex) ||
                                    (iRowIndex2 != t.AutoFilter.SortState.EndRowIndex)) t.IsNewTable = true;
                        ...
                        if (t.HasSortState)
                        {
                            ...
                            AddRowColumnIndexDelta(StartRowIndex, NumberOfRows, true, ref iRowIndex, ref iRowIndex2);
                            if ((iRowIndex != t.SortState.StartRowIndex) || (iRowIndex2 != t.SortState.EndRowIndex))
                                t.IsNewTable = true;
                ...
                SLRowProperties rp;
                var listRowIndex = slws.RowProperties.Keys.ToList();
                ...
                for (i = 0; i < listCellRefKeys.Count; ++i)
                {
                    ...
                    c = slws.Cells[pt];
                    ProcessCellFormulaDelta(ref c, StartRowIndex, NumberOfRows, -1, 0);
                ...
                listCellRefKeys = slws.Comments.Keys.ToList();
                // this sorting in descending order is crucial!
                listCellRefKeys.Sort(new SLCellReferencePointComparer());
                listCellRefKeys.Reverse();
                ...
                if (slws.MergeCells.Count > 0)
                {
                    ...
                    for (i = 0; i < slws.MergeCells.Count; ++i)
                    {
                        ...
                        AddRowColumnIndexDelta(StartRowIndex, NumberOfRows, true, ref mc.iStartRowIndex,
                            ref mc.iEndRowIndex);
                ...
                if (slws.Hyperlinks.Count > 0)
                {
                    ...
                    for (i = 0; i < slws.Hyperlinks.Count; ++i)
                    {
                        ...
                        AddRowColumnIndexDelta(StartRowIndex, NumberOfRows, true, ref iRowIndex, ref iRowIndex2);
                        hl.Reference = new SLCellPointRange(iRowIndex, hl.Reference.StartColumnIndex, iRowIndex2,
                            hl.Reference.EndColumnIndex);
                ...
                if (!string.IsNullOrEmpty(gsSelectedWorksheetRelationshipID))
                {
                    ...
                    if (wsp.DrawingsPart != null)
                    {
                        ...
                        var vEditAs = Xdr.EditAsValues.Absolute;
                        var listoxe = new List<OpenXmlElement>();
                        var iIndex = 0;

                        var dp = wsp.DrawingsPart;
                        foreach (var oxe in dp.WorksheetDrawing.ChildElements)
                                    ...
                                    if ((tcaNew.FromMarker != null) && (tcaNew.FromMarker.RowId != null))
                                    {
                                        ...
                                        if (iIndex + 1 >= StartRowIndex)
                                        {
                                            ...
                                            if ((tcaNew.ToMarker != null) && (tcaNew.ToMarker.RowId != null))
                                            {
                                                iIndex = Convert.ToInt32(tcaNew.ToMarker.RowId.Text);
                                                iIndex += NumberOfRows;
                                                tcaNew.ToMarker.RowId.Text =
                                                    iIndex.ToString(CultureInfo.InvariantCulture);
                                            }
                                        }
                                    }
                                }
                ...
                if (slwb.CalculationCells.Count > 0)
                    foreach (var cc in slwb.CalculationCells)
                ...
                {
                    var sDefinedNameText = string.Empty;
                    foreach (var d in slwb.DefinedNames)
                    {
                        sDefinedNameText = d.Text;
                        sDefinedNameText = AddDeleteCellFormulaDelta(sDefinedNameText, StartRowIndex, NumberOfRows, -1,
                            0);
                        sDefinedNameText = AddDeleteDefinedNameRowColumnRangeDelta(sDefinedNameText, true, StartRowIndex,
                            NumberOfRows);
                ...
                {
                    SLSparkline spk;
                    foreach (var spkgrp in slws.SparklineGroups)
                    {
                        if (spkgrp.DateAxis &&
                            spkgrp.DateWorksheetName.Equals(gsSelectedWorksheetName, StringComparison.OrdinalIgnoreCase))
                            AddRowColumnIndexDelta(StartRowIndex, NumberOfRows, true, ref spkgrp.DateStartRowIndex,
                                ref spkgrp.DateEndRowIndex);
                        ...
                        for (i = spkgrp.Sparklines.Count - 1; i >= 0; --i)
                        {
                            ...
                            if (spk.WorksheetName.Equals(gsSelectedWorksheetName, StringComparison.OrdinalIgnoreCase))
                                AddRowColumnIndexDelta(StartRowIndex, NumberOfRows, true, ref spk.StartRowIndex,
                                    ref spk.EndRowIndex);
        ...
        public bool DeleteRow(int StartRowIndex, int NumberOfRows)
        {
            ...
            if ((StartRowIndex >= 1) && (StartRowIndex <= SLConstants.RowLimit))
            {
                result = true;
                int i = 0, iNewIndex = 0;
                var iEndRowIndex = StartRowIndex + NumberOfRows - 1;
                if (iEndRowIndex > SLConstants.RowLimit) iEndRowIndex = SLConstants.RowLimit;
                // this autocorrects in the case of overshooting the row limit
                var iNumberOfRows = iEndRowIndex - StartRowIndex + 1;
                ...
                if (slws.Tables.Count > 0)
                {
                    ...
                    for (i = 0; i < slws.Tables.Count; ++i)
                    {
                        ...
                        if (t.HeaderRowCount > 0)
                            if ((StartRowIndex <= t.StartRowIndex) && (t.StartRowIndex <= iEndRowIndex) &&
                                (iEndRowIndex < t.EndRowIndex))
                                return false;
                    ...
                    var listTablesToDelete = new List<int>();
                    for (i = 0; i < slws.Tables.Count; ++i)
                    {
                        t = slws.Tables[i];
                        ...
                        iRowIndex = t.StartRowIndex;
                        iRowIndex2 = t.EndRowIndex;
                        DeleteRowColumnIndexDelta(StartRowIndex, iEndRowIndex, iNumberOfRows, ref iRowIndex,
                            ref iRowIndex2);
                        if ((iRowIndex != t.StartRowIndex) || (iRowIndex2 != t.EndRowIndex)) t.IsNewTable = true;
                        t.StartRowIndex = iRowIndex;
                        t.EndRowIndex = iRowIndex2;
                ...
                if (slws.MergeCells.Count > 0)
                {
                    ...
                    for (i = slws.MergeCells.Count - 1; i >= 0; --i)
                    {
                        ...
                        {
                            DeleteRowColumnIndexDelta(StartRowIndex, iEndRowIndex, iNumberOfRows, ref mc.iStartRowIndex,
                                ref mc.iEndRowIndex);
                            slws.MergeCells[i] = mc;
                        }
                    }
                ...
                if (slws.Hyperlinks.Count > 0)
                {
                    var deletepoints = new List<SLCellPoint>();
                    SLHyperlink hl;
                    ...
                    foreach (var hyperlinkpt in deletepoints)
                        RemoveHyperlink(hyperlinkpt.RowIndex, hyperlinkpt.ColumnIndex);
                }
                ...
                if (!string.IsNullOrEmpty(gsSelectedWorksheetRelationshipID))
                {
                    ...
                    if (wsp.DrawingsPart != null)
                    {
                        ...
                        var lDefaultHeight = slws.SheetFormatProperties.DefaultRowHeightInEMU;
                        var dictRowHeight = new Dictionary<int, long>();
                        var listindex = slws.RowProperties.Keys.ToList();
                        foreach (var rowindex in listindex)
                        {
                            rp = slws.RowProperties[rowindex];
                            dictRowHeight[rowindex] = rp.HeightInEMU;
                        }

                        var dictCumulativeLength = new Dictionary<int, long>();
                            ...
                            if (oxe is Xdr.TwoCellAnchor)
                            {
                                    ...
                                    && (tcaNew.ToMarker != null) && (tcaNew.ToMarker.RowId != null))
                                {
                                    ...
                                    if (vEditAs == Xdr.EditAsValues.TwoCell)
                                    {
                                        ...
                                        else if ((lStartDelete <= lAnchorStartDelete) && (lAnchorStartDelete <= lEndDelete) &&
                                                 (lEndDelete <= lAnchorEndDelete))
                                        {
                                        ...
                                        else if ((lAnchorStartDelete <= lStartDelete) &&
                                                 (lStartDelete <= lAnchorEndDelete) &&
                                                 (lAnchorEndDelete <= lEndDelete))
                                        {
                                    ...
                                    if (bToFindCumulative)
                                    {
                                        ...
                                        for (i = dictCumulativeLength.Count; i >= 0; --i)
                                        {
                                            if (i == 0)
                                            {
                                                ...
                                                {
                                                    iIndex = 0;
                                                    tcaNew.FromMarker.RowId =
                                                        new Xdr.RowId(iIndex.ToString(CultureInfo.InvariantCulture));
                                                    tcaNew.FromMarker.RowOffset =
                                                        new Xdr.RowOffset(
                                                            lAnchorStartDelete.ToString(CultureInfo.InvariantCulture));
                                                }

                                                if (iIndex2 < 0)
                                                {
                                                    iIndex2 = 0;
                                                    tcaNew.ToMarker.RowId =
                                                        new Xdr.RowId(iIndex2.ToString(CultureInfo.InvariantCulture));
                                                    tcaNew.ToMarker.RowOffset =
                                                        new Xdr.RowOffset(
                                                            lAnchorEndDelete.ToString(CultureInfo.InvariantCulture));
                                                }
                                            }
                                            ...
                                            if ((iIndex < 0) && (lAnchorStartDelete >= dictCumulativeLength[i]))
                                            {
                                                ...
                                                tcaNew.FromMarker.RowOffset =
                                                    new Xdr.RowOffset(
                                                        (lAnchorStartDelete - dictCumulativeLength[i]).ToString(
                                            ...
                                            if ((iIndex2 < 0) && (lAnchorEndDelete >= dictCumulativeLength[i]))
                                            {
                                                ...
                                                tcaNew.ToMarker.RowOffset =
                                                    new Xdr.RowOffset(
                                                        (lAnchorEndDelete - dictCumulativeLength[i]).ToString(
                                                            CultureInfo.InvariantCulture));
                                            }
                ...
                if (slwb.CalculationCells.Count > 0)
                {
                    ...
                    for (i = 0; i < slwb.CalculationCells.Count; ++i)
                        if (slwb.CalculationCells[i].SheetId == giSelectedWorksheetID)
                            if ((StartRowIndex <= slwb.CalculationCells[i].RowIndex) &&
                                (slwb.CalculationCells[i].RowIndex <= iEndRowIndex))
                                listToDelete.Add(i);
                    ...
                    foreach (var spkgrp in slws.SparklineGroups)
                    {
                        if (spkgrp.DateAxis &&
                            ...
                            if ((StartRowIndex <= spkgrp.DateStartRowIndex) && (spkgrp.DateEndRowIndex <= iEndRowIndex))
                                ...
                                DeleteRowColumnIndexDelta(StartRowIndex, iEndRowIndex, iNumberOfRows,
                                    ref spkgrp.DateStartRowIndex, ref spkgrp.DateEndRowIndex);
                        ...
                        for (i = spkgrp.Sparklines.Count - 1; i >= 0; --i)
                        {
                            ...
                            if (spk.LocationRowIndex > iEndRowIndex)
                            {
                            ...
                            if (spk.WorksheetName.Equals(gsSelectedWorksheetName, StringComparison.OrdinalIgnoreCase))
                            {
                                ...
                                DeleteRowColumnIndexDelta(StartRowIndex, iEndRowIndex, iNumberOfRows,
                                    ref spk.StartRowIndex, ref spk.EndRowIndex);
                            }
        ...
        /// <summary>
        ///     Clear all cell content within specified rows. If the top-left cell of a merged cell is within specified rows, the
        ///     merged cell content is also cleared.
        /// </summary>
        /// <param name="StartRowIndex">The row index of the starting row.</param>
        /// <param name="EndRowIndex">The row index of the ending row.</param>
        /// <returns>
        ///     True if content has been cleared. False otherwise. If there are no content within specified rows, false is
        ///     also returned.
        /// </returns>
        ...
        public bool HasColumnStyle(int ColumnIndex)
        {
            ...
            {
                var cp = slws.ColumnProperties[ColumnIndex];
                if (cp.StyleIndex > 0)
                    result = true;
            }
        ...
        /// <summary>
        ///     Get the column width. If the column doesn't have a width explicitly set, the default column width for the current
        ///     worksheet is returned.
        /// </summary>
        /// <param name="ColumnName">The column name, such as "A".</param>
        ...
        {
            var fWidth = slws.SheetFormatProperties.DefaultColumnWidth;
            if (slws.ColumnProperties.ContainsKey(ColumnIndex))
            {
                var cp = slws.ColumnProperties[ColumnIndex];
                if (cp.HasWidth)
        ...
        public bool SetColumnWidth(int StartColumnIndex, int EndColumnIndex, double ColumnWidth)
        {
            ...
            var result = false;
            if ((iStartColumnIndex >= 1) && (iStartColumnIndex <= SLConstants.ColumnLimit) && (iEndColumnIndex >= 1) &&
                (iEndColumnIndex <= SLConstants.ColumnLimit))
            {
                ...
                for (i = iStartColumnIndex; i <= iEndColumnIndex; ++i)
                    ...
                    {
                        cp = new SLColumnProperties(SimpleTheme.ThemeColumnWidth, SimpleTheme.ThemeColumnWidthInEMU,
                            SimpleTheme.ThemeMaxDigitWidth, SimpleTheme.listColumnStepSize);
                        cp.Width = ColumnWidth;
        ...
        public void AutoFitColumn(string ColumnName)
        {
            ...
            AutoFitColumn(iColumnIndex, iColumnIndex, SLConstants.MaximumColumnWidth);
        }
        ...
        public void AutoFitColumn(string ColumnName, double MaximumColumnWidth)
        {
            ...
            AutoFitColumn(iColumnIndex, iColumnIndex, MaximumColumnWidth);
        }
        ...
        public void AutoFitColumn(string StartColumnName, string EndColumnName)
        {
            ...
            AutoFitColumn(iStartColumnIndex, iEndColumnIndex, SLConstants.MaximumColumnWidth);
        }
        ...
        public void AutoFitColumn(string StartColumnName, string EndColumnName, double MaximumColumnWidth)
        {
            ...
            AutoFitColumn(iStartColumnIndex, iEndColumnIndex, MaximumColumnWidth);
        }
        ...
        {
            AutoFitColumn(ColumnIndex, ColumnIndex, SLConstants.MaximumColumnWidth);
        }
        ...
        {
            AutoFitColumn(ColumnIndex, ColumnIndex, MaximumColumnWidth);
        }
        ...
        {
            AutoFitColumn(StartColumnIndex, EndColumnIndex, SLConstants.MaximumColumnWidth);
        }
        ...
        public void AutoFitColumn(int StartColumnIndex, int EndColumnIndex, double MaximumColumnWidth)
        {
            ...
            if (MaximumColumnWidth > SLConstants.MaximumColumnWidth)
                MaximumColumnWidth = SLConstants.MaximumColumnWidth;
            // this is taken from SLColumnProperties...
            var iWholeNumber = Convert.ToInt32(Math.Truncate(MaximumColumnWidth));
            var fStepRemainder = MaximumColumnWidth - iWholeNumber;
            var iStep = 0;
            ...
            if (iStep < 0) iStep = 0;
            var iMaximumPixelLength = iWholeNumber*(SimpleTheme.ThemeMaxDigitWidth - 1) + iStep;

            var pixellength = AutoFitRowColumn(false, iStartColumnIndex, iEndColumnIndex, iMaximumPixelLength);
            ...
            foreach (var pixlenpt in pixellength.Keys)
            {
                ...
                if (iPixelLength > 0)
                {
                    fWholeNumber = iPixelLength/(SimpleTheme.ThemeMaxDigitWidth - 1);
                    fRemainder = iPixelLength%(SimpleTheme.ThemeMaxDigitWidth - 1);
                    fRemainder = fRemainder/(SimpleTheme.ThemeMaxDigitWidth - 1);
        ...
        /// </summary>
        /// <param name="StartColumnName">
        ///     The column name of the start column of the column range. This is typically the left-most
        ///     column.
        /// </param>
        /// <param name="EndColumnName">
        ///     The column name of the end column of the column range. This is typically the right-most
        ///     column.
        /// </param>
        ...
        ///     The column index of the start column of the column range. This is typically the
        ///     left-most column.
        /// </param>
        /// <param name="EndColumnIndex">
        ///     The column index of the end column of the column range. This is typically the right-most
        ///     column.
        /// </param>
        ...
        public bool CopyColumn(int StartColumnIndex, int EndColumnIndex, int AnchorColumnIndex, bool ToCut)
        {
                ...
                && (iStartColumnIndex != AnchorColumnIndex))
            {
                ...
                var diff = AnchorColumnIndex - iStartColumnIndex;
                var i = 0;
                var cols = new Dictionary<int, SLColumnProperties>();
                for (i = iStartColumnIndex; i <= iEndColumnIndex; ++i)
                    if (slws.ColumnProperties.ContainsKey(i))
                    {
                ...
                var colkeys = slws.ColumnProperties.Keys.ToList();
                foreach (var ckey in colkeys)
                ...
                {
                    c = cells[key];
                    ProcessCellFormulaDelta(ref c, -1, 0, AnchorColumnIndex, iNumberOfColumns);
                    slws.Cells[key] = c;
                }
                ...
                foreach (var mc in mca)
                    if ((mc.StartColumnIndex >= iStartColumnIndex) && (mc.EndColumnIndex <= iEndColumnIndex))
                    {
                        if (ToCut)
                            slws.MergeCells.Remove(mc);
                        MergeWorksheetCells(mc.StartRowIndex, mc.StartColumnIndex + diff, mc.EndRowIndex,
                            mc.EndColumnIndex + diff);
                    }
                ...
                {
                    var listToDelete = new List<int>();
                    var iColumnLimit = AnchorColumnIndex + iStartColumnIndex - iEndColumnIndex;
                    for (i = 0; i < slwb.CalculationCells.Count; ++i)
                        if (slwb.CalculationCells[i].SheetId == giSelectedWorksheetID)
                        {
                            if (ToCut && (slwb.CalculationCells[i].ColumnIndex >= iStartColumnIndex) &&
                                (slwb.CalculationCells[i].ColumnIndex <= iEndColumnIndex))
                                if (!listToDelete.Contains(i)) listToDelete.Add(i);

                            if ((slwb.CalculationCells[i].ColumnIndex >= AnchorColumnIndex) &&
                                (slwb.CalculationCells[i].ColumnIndex <= iColumnLimit))
                                if (!listToDelete.Contains(i)) listToDelete.Add(i);
                        }
        ...
        ///     The column name (such as "A1") of the column just after the group of columns you want to
        ///     collapse. For example, this will be column E if columns B to D are grouped.
        /// </param>
        ...
        ///     The column index of the column just after the group of columns you want to collapse. For
        ///     example, this will be column 5 if columns 2 to 4 are grouped.
        /// </param>
        ...
        /// <param name="ColumnName">
        ///     The column name (such as "A1") of the column just after the group of columns you want to
        ///     expand. For example, this will be column E if columns B to D are grouped.
        /// </param>
        ...
        /// </summary>
        /// <param name="ColumnIndex">
        ///     The column index of the column just after the group of columns you want to expand. For
        ///     example, this will be column 5 if columns 2 to 4 are grouped.
        /// </param>
            ...
            if (slws.ColumnProperties.ContainsKey(ColumnIndex))
            {
                ...
                if (cp.Collapsed)
                    ...
                    else
                    {
                        ...
                        var byCurrentOutlineLevel = cp.OutlineLevel;
                        int i;
                        for (i = ColumnIndex - 1; i >= 1; --i)
                            if (slws.ColumnProperties.ContainsKey(i))
                            {
        ...
        public bool InsertColumn(int StartColumnIndex, int NumberOfColumns)
        {
            ...
            if ((StartColumnIndex >= 1) && (StartColumnIndex <= SLConstants.ColumnLimit))
            {
                ...
                SLColumnProperties cp;
                var listColumnIndex = slws.ColumnProperties.Keys.ToList();
                // this sorting in descending order is crucial!
                // we move the data from after the insert range to their new reference keys
                // first, then we put in the new data, which will then have no data
                // key collision.
                ...
                for (i = 0; i < listCellRefKeys.Count; ++i)
                {
                    pt = listCellRefKeys[i];
                    c = slws.Cells[pt];
                    ProcessCellFormulaDelta(ref c, -1, 0, StartColumnIndex, NumberOfColumns);
                ...
                {
                    var iNewID = 0;
                    var sNewColumnName = string.Empty;
                    var iCount = 0;
                    ...
                    foreach (var t in slws.Tables)
                    {
                        ...
                        if ((iColumnIndex < StartColumnIndex) && (StartColumnIndex <= iColumnIndex2))
                        {
                            for (i = 0; i < NumberOfColumns; ++i)
                            {
                                ...
                                for (iNewID = 1; iNewID <= SLConstants.ColumnLimit; ++iNewID)
                                {
                                    ...
                                    iCount =
                                        t.TableColumns.Count(
                                            n => n.Name.Equals(sNewColumnName, StringComparison.OrdinalIgnoreCase));
                                    if (iCount == 0) break;
                                }
                                ...
                                if (t.HeaderRowCount > 0)
                                {
                                    ...
                                    SetCellValue(t.StartRowIndex, iNewIndex, sNewColumnName);
                                }

                                t.TableColumns.Insert(StartColumnIndex - iColumnIndex + i,
                                    new SLTableColumn {Id = (uint) iNewID, Name = sNewColumnName});
                            }
                        ...
                        AddRowColumnIndexDelta(StartColumnIndex, NumberOfColumns, false, ref iColumnIndex,
                            ref iColumnIndex2);
                        if ((iColumnIndex != t.StartColumnIndex) || (iColumnIndex2 != t.EndColumnIndex))
                            t.IsNewTable = true;
                        ...
                        if (t.HasAutoFilter)
                        {
                            ...
                            AddRowColumnIndexDelta(StartColumnIndex, NumberOfColumns, false, ref iColumnIndex,
                                ref iColumnIndex2);
                            if ((iColumnIndex != t.AutoFilter.StartColumnIndex) ||
                                (iColumnIndex2 != t.AutoFilter.EndColumnIndex)) t.IsNewTable = true;
                            ...
                            if (t.AutoFilter.HasSortState)
                            {
                                ...
                                AddRowColumnIndexDelta(StartColumnIndex, NumberOfColumns, false, ref iColumnIndex,
                                    ref iColumnIndex2);
                                if ((iColumnIndex != t.AutoFilter.SortState.StartColumnIndex) ||
                                    (iColumnIndex2 != t.AutoFilter.SortState.EndColumnIndex)) t.IsNewTable = true;
                        ...
                        if (t.HasSortState)
                        {
                            ...
                            AddRowColumnIndexDelta(StartColumnIndex, NumberOfColumns, false, ref iColumnIndex,
                                ref iColumnIndex2);
                            if ((iColumnIndex != t.SortState.StartColumnIndex) ||
                                (iColumnIndex2 != t.SortState.EndColumnIndex)) t.IsNewTable = true;
                ...
                if (slws.MergeCells.Count > 0)
                {
                    ...
                    {
                        mc = slws.MergeCells[i];
                        AddRowColumnIndexDelta(StartColumnIndex, NumberOfColumns, false, ref mc.iStartColumnIndex,
                            ref mc.iEndColumnIndex);
                        slws.MergeCells[i] = mc;
                    }
                }
                ...
                if (slws.Hyperlinks.Count > 0)
                {
                    ...
                    for (i = 0; i < slws.Hyperlinks.Count; ++i)
                    {
                        ...
                        AddRowColumnIndexDelta(StartColumnIndex, NumberOfColumns, false, ref iColumnIndex,
                            ref iColumnIndex2);
                        hl.Reference = new SLCellPointRange(hl.Reference.StartRowIndex, iColumnIndex,
                            hl.Reference.EndRowIndex, iColumnIndex2);
                        slws.Hyperlinks[i] = hl.Clone();
                    }
                }
                                ...
                                if (vEditAs == Xdr.EditAsValues.TwoCell)
                                {
                                    if ((tcaNew.FromMarker != null) && (tcaNew.FromMarker.ColumnId != null))
                                    {
                                        ...
                                        if (iIndex + 1 >= StartColumnIndex)
                                        {
                                            ...
                                            bFound = true;
                                            tcaNew.FromMarker.ColumnId.Text =
                                                iIndex.ToString(CultureInfo.InvariantCulture);
                                        }
                                    }
                ...
                if (slwb.DefinedNames.Count > 0)
                {
                    ...
                    {
                        sDefinedNameText = d.Text;
                        sDefinedNameText = AddDeleteCellFormulaDelta(sDefinedNameText, -1, 0, StartColumnIndex,
                            NumberOfColumns);
                        sDefinedNameText = AddDeleteDefinedNameRowColumnRangeDelta(sDefinedNameText, false,
                            StartColumnIndex, NumberOfColumns);
                        d.Text = sDefinedNameText;
                    }
                }
                ...
                if (slws.SparklineGroups.Count > 0)
                {
                    ...
                    foreach (var spkgrp in slws.SparklineGroups)
                    {
                        if (spkgrp.DateAxis &&
                            spkgrp.DateWorksheetName.Equals(gsSelectedWorksheetName, StringComparison.OrdinalIgnoreCase))
                            AddRowColumnIndexDelta(StartColumnIndex, NumberOfColumns, false,
                                ref spkgrp.DateStartColumnIndex, ref spkgrp.DateEndColumnIndex);
                        ...
                        for (i = spkgrp.Sparklines.Count - 1; i >= 0; --i)
                        {
                            ...
                            if (spk.WorksheetName.Equals(gsSelectedWorksheetName, StringComparison.OrdinalIgnoreCase))
                                AddRowColumnIndexDelta(StartColumnIndex, NumberOfColumns, false,
                                    ref spk.StartColumnIndex, ref spk.EndColumnIndex);
        ...
        public bool DeleteColumn(int StartColumnIndex, int NumberOfColumns)
        {
            ...
            if ((StartColumnIndex >= 1) && (StartColumnIndex <= SLConstants.ColumnLimit))
            {
                result = true;
                int i = 0, iNewIndex = 0;
                var iEndColumnIndex = StartColumnIndex + NumberOfColumns - 1;
                if (iEndColumnIndex > SLConstants.ColumnLimit) iEndColumnIndex = SLConstants.ColumnLimit;
                // this autocorrects in the case of overshooting the column limit
                var iNumberOfColumns = iEndColumnIndex - StartColumnIndex + 1;
                ...
                if (slws.Tables.Count > 0)
                {
                    ...
                    for (i = 0; i < slws.Tables.Count; ++i)
                    {
                        ...
                        else if ((iColumnIndex < StartColumnIndex) && (StartColumnIndex <= iColumnIndex2) &&
                                 (iColumnIndex2 <= iEndColumnIndex))
                        {
                        ...
                        DeleteRowColumnIndexDelta(StartColumnIndex, iEndColumnIndex, iNumberOfColumns, ref iColumnIndex,
                            ref iColumnIndex2);
                        if ((iColumnIndex != t.StartColumnIndex) || (iColumnIndex2 != t.EndColumnIndex))
                            t.IsNewTable = true;
                        t.StartColumnIndex = iColumnIndex;
                        ...
                        if (t.HasAutoFilter)
                        {
                            ...
                            iColumnIndex = t.AutoFilter.StartColumnIndex;
                            iColumnIndex2 = t.AutoFilter.EndColumnIndex;
                            DeleteRowColumnIndexDelta(StartColumnIndex, iEndColumnIndex, iNumberOfColumns,
                ...
                if (slws.MergeCells.Count > 0)
                {
                    ...
                    for (i = slws.MergeCells.Count - 1; i >= 0; --i)
                    {
                        ...
                        {
                            DeleteRowColumnIndexDelta(StartColumnIndex, iEndColumnIndex, iNumberOfColumns,
                                ref mc.iStartColumnIndex, ref mc.iEndColumnIndex);
                            slws.MergeCells[i] = mc;
                        }
                    }
                }
                ...
                if (slws.Hyperlinks.Count > 0)
                {
                    ...
                    {
                        hl = slws.Hyperlinks[i];
                        if ((StartColumnIndex <= hl.Reference.StartColumnIndex) &&
                ...
                if (!string.IsNullOrEmpty(gsSelectedWorksheetRelationshipID))
                {
                    ...
                    if (wsp.DrawingsPart != null)
                    {
                        ...
                        var lDefaultWidth = slws.SheetFormatProperties.DefaultColumnWidthInEMU;
                        var dictColumnWidth = new Dictionary<int, long>();
                        var listindex = slws.ColumnProperties.Keys.ToList();
                        foreach (var colindex in listindex)
                        {
                                    ...
                                    if (bToFindCumulative)
                                    {
                                        ...
                                        for (i = dictCumulativeLength.Count; i >= 0; --i)
                                        {
                                            if (i == 0)
                                            {
                                                ...
                                                {
                                                    iIndex = 0;
                                                    tcaNew.FromMarker.ColumnId =
                                                        new Xdr.ColumnId(iIndex.ToString(CultureInfo.InvariantCulture));
                                                    tcaNew.FromMarker.ColumnOffset =
                                                        new Xdr.ColumnOffset(
                                                            lAnchorStartDelete.ToString(CultureInfo.InvariantCulture));
                                                }
                                                ...
                                                {
                                                    iIndex2 = 0;
                                                    tcaNew.ToMarker.ColumnId =
                                                        new Xdr.ColumnId(iIndex2.ToString(CultureInfo.InvariantCulture));
                                                    tcaNew.ToMarker.ColumnOffset =
                                                        new Xdr.ColumnOffset(
                                                            lAnchorEndDelete.ToString(CultureInfo.InvariantCulture));
                                                }
                                            }
                ...
                if (slwb.CalculationCells.Count > 0)
                {
                    ...
                    for (i = 0; i < slwb.CalculationCells.Count; ++i)
                        if (slwb.CalculationCells[i].SheetId == giSelectedWorksheetID)
                            if ((StartColumnIndex <= slwb.CalculationCells[i].ColumnIndex) &&
                                (slwb.CalculationCells[i].ColumnIndex <= iEndColumnIndex))
                                listToDelete.Add(i);
                ...
                if (slws.SparklineGroups.Count > 0)
                {
                    ...
                    foreach (var spkgrp in slws.SparklineGroups)
                    {
                        if (spkgrp.DateAxis &&
                            spkgrp.DateWorksheetName.Equals(gsSelectedWorksheetName, StringComparison.OrdinalIgnoreCase))
                            if ((StartColumnIndex <= spkgrp.DateStartColumnIndex) &&
                                (spkgrp.DateEndColumnIndex <= iEndColumnIndex))
                                spkgrp.DateAxis = false;
                            else
                                DeleteRowColumnIndexDelta(StartColumnIndex, iEndColumnIndex, iNumberOfColumns,
                                    ref spkgrp.DateStartColumnIndex, ref spkgrp.DateEndColumnIndex);
                        ...
                        for (i = spkgrp.Sparklines.Count - 1; i >= 0; --i)
                        {
                            ...
                            if ((StartColumnIndex <= spk.LocationColumnIndex) &&
                                (spk.LocationColumnIndex <= iEndColumnIndex))
                            {
                                spkgrp.Sparklines.RemoveAt(i);
                                continue;
                            }
                            if (spk.LocationColumnIndex > iEndColumnIndex)
                            {
                            ...
                            if (spk.WorksheetName.Equals(gsSelectedWorksheetName, StringComparison.OrdinalIgnoreCase))
                            {
                                if ((StartColumnIndex <= spk.StartColumnIndex) &&
        ...
        /// <summary>
        ///     Clear all cell content within specified columns. If the top-left cell of a merged cell is within specified columns,
        ///     the merged cell content is also cleared.
        /// </summary>
        /// <param name="StartColumnName">The column name of the start column.</param>
        /// <param name="EndColumnName">The column name of the end column.</param>
        /// <returns>
        ...
        internal void AddRowColumnIndexDelta(int GivenStartIndex, int Delta, bool IsRow, ref int CurrentStartIndex,
            ref int CurrentEndIndex)
        {
        ...
        /// <param name="CurrentStartIndex"></param>
        /// <param name="CurrentEndIndex"></param>
        internal void DeleteRowColumnIndexDelta(int GivenStartIndex, int GivenEndIndex, int Delta,
            ref int CurrentStartIndex, ref int CurrentEndIndex)
        {
            ...
            else if ((GivenStartIndex <= CurrentStartIndex) && (CurrentStartIndex <= GivenEndIndex) &&
                     (GivenEndIndex < CurrentEndIndex))
            {
            ...
            else if ((CurrentStartIndex < GivenStartIndex) && (GivenStartIndex <= CurrentEndIndex) &&
                     (CurrentEndIndex <= GivenEndIndex))
            {
        ...
        internal Dictionary<int, int> AutoFitRowColumn(bool IsRow, int StartIndex, int EndIndex, int MaxPixelLength)
        {
                ...
                for (i = ptkeys.Count - 1; i >= 0; --i)
                {
                    ...
                    foreach (var mc in slws.MergeCells)
                        if ((mc.StartRowIndex <= ptCheck.RowIndex) && (ptCheck.RowIndex <= mc.EndRowIndex)
                            && (mc.StartColumnIndex <= ptCheck.ColumnIndex) &&
                            (ptCheck.ColumnIndex <= mc.EndColumnIndex))
                        {
                            ptkeys.RemoveAt(i);
                            break;
                        }
            ...
            var hsFilter = new HashSet<SLCellPoint>();
                    ...
                    foreach (var pt in ptkeys)
                    {
                        ...
                        if ((StartIndex <= iPointIndex) && (iPointIndex <= EndIndex))
                        {
                            ...
                            else
                            {
                                ...
                                dictAutoFitFontCache[iStyleIndex] = (Font) ftUsable.Clone();
                            ...
                            if (c.DataType == CellValues.SharedString)
                            {
                                ...
                                else if ((index >= 0) && (index < listSharedString.Count))
                                {
                                    ...
                                    if ((rst.istrReal.ChildElements.Count == 1) && (rst.istrReal.Text != null))
                                    {
                                        ...
                                        sAutoFitCacheKey = string.Format("{0}{1}{2}", sText,
                                            SLConstants.AutoFitCacheSeparator,
                                            iStyleIndex.ToString(CultureInfo.InvariantCulture));
                                        ...
                                        else
                                        {
                                            ...
                                            fHeight = szf.Height;
                                            fWidth = szf.Width;
                                            dictAutoFitTextCache[sAutoFitCacheKey] = new SizeF(fWidth, fHeight);
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        foreach (var child in rst.istrReal.ChildElements.Reverse())
                                            if (child is Text || child is Run)
                                            {
                                                ...
                                                {
                                                    sText = string.Empty;
                                                    sFontName = (ftUsable.Name != null) && (ftUsable.Name.Length > 0)
                                                        ? ftUsable.Name
                                                        : SimpleTheme.MinorLatinFont;
                                                    fFontSize = ftUsable.SizeInPoints;
                                                    bBold = (ftUsable.Style & FontStyle.Bold) > 0 ? true : false;
                                                    bItalic = (ftUsable.Style & FontStyle.Italic) > 0 ? true : false;
                                                    bStrike = (ftUsable.Style & FontStyle.Strikeout) > 0 ? true : false;
                                                    bUnderline = (ftUsable.Style & FontStyle.Underline) > 0
                                                        ? true
                                                        : false;
                                                    drawstyle = FontStyle.Regular;
                                                    ...
                                                    if (run.RunProperties != null)
                                                        foreach (var grandchild in run.RunProperties.ChildElements)
                                                            ...
                                                            else if (grandchild is Underline)
                                                            {
                                                                ...
                                                                {
                                                                    if (und.Val.Value != UnderlineValues.None)
                                                                        bUnderline = true;
                                                    ...
                                                    if (vFontScheme == FontSchemeValues.Major)
                                                        sFontName = SimpleTheme.MajorLatinFont;
                                                    else if (vFontScheme == FontSchemeValues.Minor)
                                                        sFontName = SimpleTheme.MinorLatinFont;
                                                    ...
                                                    szf = SLTool.MeasureText(bm, g, sText,
                                                        SLTool.GetUsableNormalFont(sFontName, fFontSize, drawstyle));
                                                    if (szf.Height > fHeight) fHeight = szf.Height;
                                                    fWidth += szf.Width;
                                                }
                            ...
                            else
                            {
                                ...
                                sAutoFitCacheKey = string.Format("{0}{1}{2}", sText, SLConstants.AutoFitCacheSeparator,
                                    iStyleIndex.ToString(CultureInfo.InvariantCulture));
                                if (dictAutoFitTextCache.ContainsKey(sAutoFitCacheKey))
                                {
                                    szf = dictAutoFitTextCache[sAutoFitCacheKey];
                            ...
                            if (!bSkipAdjustment)
                            {
                                ...
                                if (sAutoFitSharedStringCacheKey.Length > 0)
                                    dictAutoFitSharedStringCache[sAutoFitSharedStringCacheKey] = new SizeF(fWidth,
                                        fHeight);
                            }
