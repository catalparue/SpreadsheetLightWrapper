...
using SpreadsheetLightWrapper.Core.pivottable;
...
using SLFill = SpreadsheetLightWrapper.Core.style.SLFill;
using SLGradientFill = SpreadsheetLightWrapper.Core.style.SLGradientFill;
