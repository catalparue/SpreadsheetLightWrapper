...
namespace Ups.Toolkit.SpreadsheetLight.Core.Charts
{
    ...
    {
        internal static bool IsSuitableCategoryHeader(Dictionary<SLCellPoint, SLCell> Cells, int RowIndex,
            int ColumnIndex)
        {
            var result = false;
        ...
        internal static string GetChartReferenceFormula(string WorksheetName, int StartRowIndex, int StartColumnIndex,
