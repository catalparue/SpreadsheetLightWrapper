...
namespace Ups.Toolkit.SpreadsheetLight.Core.conditionalformatting
{
    ...
    public enum SLConditionalFormatAutoMinMaxValues
    {
        ...
        /// <summary>
        ///     Automatic. The underlying engine will assign a minimum or maximum depending on the parameter this value is used on.
        ///     This is an Excel 2010 specific feature.
        /// </summary>
        Automatic
    }
    ...
    /// <summary>
    ///     Encapsulates properties and methods for conditional formatting. This simulates the
    ///     DocumentFormat.OpenXml.Spreadsheet.ConditionalFormatting class.
    /// </summary>
    public class SLConditionalFormatting
    {
        ...
        ///     The cell reference of the start cell of the cell range to be conditionally formatted,
        ///     such as "A1". This is typically the top-left cell.
        /// </param>
        /// <param name="EndCellReference">
        ///     The cell reference of the end cell of the cell range to be conditionally formatted, such
        ///     as "A1". This is typically the bottom-right cell.
        /// </param>
        public SLConditionalFormatting(string StartCellReference, string EndCellReference)
        {
            ...
            InitialiseNewConditionalFormatting(iStartRowIndex, iStartColumnIndex, iEndRowIndex, iEndColumnIndex);
        }
        ...
        {
            InitialiseNewConditionalFormatting(StartRowIndex, StartColumnIndex, EndRowIndex, EndColumnIndex);
        }
        ...
        private void InitialiseNewConditionalFormatting(int StartRowIndex, int StartColumnIndex, int EndRowIndex,
            int EndColumnIndex)
        {
        ...
        {
            Rules = new List<SLConditionalFormattingRule>();
            Pivot = false;
        ...
        {
            var dbo = new SLDataBarOptions(DataBar, false);
            SetCustomDataBar(dbo);
        }
        ...
        /// <param name="ShortestBarValue">
        ///     The value for the shortest bar. If <paramref name="ShortestBarType" /> is Value, you can
        ///     just set this to "0".
        /// </param>
        /// <param name="LongestBarType">The conditional format type for the longest bar.</param>
        /// <param name="LongestBarValue">
        ///     The value for the longest bar. If <paramref name="LongestBarType" /> is Value, you can
        ///     just set this to "0".
        /// </param>
        /// <param name="BarColor">The color of the data bar.</param>
        public void SetCustomDataBar(bool ShowBarOnly, uint MinLength, uint MaxLength,
            SLConditionalFormatMinMaxValues ShortestBarType, string ShortestBarValue,
            SLConditionalFormatMinMaxValues LongestBarType, string LongestBarValue, Color BarColor)
        {
            var dbo = new SLDataBarOptions(false);
            dbo.ShowBarOnly = ShowBarOnly;
            dbo.MinLength = MinLength;
            dbo.MaxLength = MaxLength;
            dbo.MinimumType = TranslateMinMaxValues(ShortestBarType);
            dbo.MinimumValue = ShortestBarValue;
            dbo.MaximumType = TranslateMinMaxValues(LongestBarType);
        ...
        public void SetCustomDataBar(bool ShowBarOnly, uint MinLength, uint MaxLength,
            SLConditionalFormatMinMaxValues ShortestBarType, string ShortestBarValue,
            SLConditionalFormatMinMaxValues LongestBarType, string LongestBarValue, SLThemeColorIndexValues BarColor)
        {
            var dbo = new SLDataBarOptions(false);
            dbo.ShowBarOnly = ShowBarOnly;
            dbo.MinLength = MinLength;
        ...
        public void SetColorScale(SLConditionalFormatColorScaleValues ColorScale)
        {
            ...
            switch (ColorScale)
            {
                case SLConditionalFormatColorScaleValues.GreenYellowRed:
                    cfr.ColorScale.Colors.Add(new SLColor(listempty, listempty)
                    {
                        Color = Color.FromArgb(0xFF, 0xF8, 0x69, 0x6B)
                    });
                    cfr.ColorScale.Colors.Add(new SLColor(listempty, listempty)
                    {
                        Color = Color.FromArgb(0xFF, 0xFF, 0xEB, 0x84)
                    });
                    cfr.ColorScale.Colors.Add(new SLColor(listempty, listempty)
                    {
                        Color = Color.FromArgb(0xFF, 0x63, 0xBE, 0x7B)
                    });
                    break;
                ...
                case SLConditionalFormatColorScaleValues.BlueYellowRed:
                    ...
                    cfr.ColorScale.Colors.Add(new SLColor(listempty, listempty)
                    {
                        Color = Color.FromArgb(0xFF, 0x5A, 0x8A, 0xC6)
                    });
                    break;
                ...
                case SLConditionalFormatColorScaleValues.GreenWhiteRed:
                    ...
                    cfr.ColorScale.Colors.Add(new SLColor(listempty, listempty)
                    {
                        Color = Color.FromArgb(0xFF, 0xFC, 0xFC, 0xFF)
                    });
                    cfr.ColorScale.Colors.Add(new SLColor(listempty, listempty)
                    {
                        Color = Color.FromArgb(0xFF, 0x63, 0xBE, 0x7B)
                ...
                case SLConditionalFormatColorScaleValues.YellowRed:
                    cfr.ColorScale.Colors.Add(new SLColor(listempty, listempty)
                    {
                        Color = Color.FromArgb(0xFF, 0xFF, 0x71, 0x28)
                    });
                    cfr.ColorScale.Colors.Add(new SLColor(listempty, listempty)
                    {
                        Color = Color.FromArgb(0xFF, 0xFF, 0xEF, 0x9C)
                    });
                    break;
        ...
        /// <param name="MinValue">
        ///     The value for the minimum. If <paramref name="MinType" /> is Value, you can just set this to
        ///     "0".
        /// </param>
        /// <param name="MinColor">The color for the minimum.</param>
        /// <param name="MaxType">The conditional format type for the maximum.</param>
        /// <param name="MaxValue">
        ///     The value for the maximum. If <paramref name="MaxType" /> is Value, you can just set this to
        ///     "0".
        /// </param>
        /// <param name="MaxColor">The color for the maximum.</param>
        public void SetCustom2ColorScale(SLConditionalFormatMinMaxValues MinType, string MinValue, Color MinColor,
            SLConditionalFormatMinMaxValues MaxType, string MaxValue, Color MaxColor)
        {
            var listempty = new List<Color>();
            var minclr = new SLColor(listempty, listempty);
            minclr.Color = MinColor;
            var maxclr = new SLColor(listempty, listempty);
            maxclr.Color = MaxColor;

            var midclr = new SLColor(listempty, listempty);
            SetCustomColorScale(MinType, MinValue, minclr, false, SLConditionalFormatRangeValues.Percentile, "", midclr,
                MaxType, MaxValue, maxclr);
        }
        ...
        /// <param name="MaxColorTint">
        ///     The tint applied to the theme color, ranging from -1.0 to 1.0. Negative tints darken the
        ///     theme color and positive tints lighten the theme color.
        /// </param>
        public void SetCustom2ColorScale(SLConditionalFormatMinMaxValues MinType, string MinValue, Color MinColor,
            SLConditionalFormatMinMaxValues MaxType, string MaxValue, SLThemeColorIndexValues MaxColor,
            double MaxColorTint)
        {
            var listempty = new List<Color>();
            var minclr = new SLColor(listempty, listempty);
        ...
        /// </param>
        /// <param name="MaxColor">The color for the maximum.</param>
        public void SetCustom2ColorScale(SLConditionalFormatMinMaxValues MinType, string MinValue,
            SLThemeColorIndexValues MinColor, double MinColorTint,
            SLConditionalFormatMinMaxValues MaxType, string MaxValue, Color MaxColor)
        {
            var listempty = new List<Color>();
            var minclr = new SLColor(listempty, listempty);
        ...
        /// </param>
        /// <param name="MaxColor">The color for the maximum.</param>
        public void SetCustom3ColorScale(SLConditionalFormatMinMaxValues MinType, string MinValue, Color MinColor,
            SLConditionalFormatRangeValues MidPointType, string MidPointValue, Color MidPointColor,
            SLConditionalFormatMinMaxValues MaxType, string MaxValue, Color MaxColor)
        {
            var listempty = new List<Color>();
            var minclr = new SLColor(listempty, listempty);
            ...
            SetCustomColorScale(MinType, MinValue, minclr, true, MidPointType, MidPointValue, midclr, MaxType, MaxValue,
                maxclr);
        }
        ...
        /// <param name="MidPointColorTint">
        ///     The tint applied to the theme color, ranging from -1.0 to 1.0. Negative tints darken
        ...
        /// <param name="MaxColor">The color for the maximum.</param>
        public void SetCustom3ColorScale(SLConditionalFormatMinMaxValues MinType, string MinValue, Color MinColor,
            SLConditionalFormatRangeValues MidPointType, string MidPointValue, SLThemeColorIndexValues MidPointColor,
            double MidPointColorTint,
            SLConditionalFormatMinMaxValues MaxType, string MaxValue, Color MaxColor)
        {
            var listempty = new List<Color>();
            var minclr = new SLColor(listempty, listempty);
        ...
        /// </param>
        /// <param name="MaxColor">The color for the maximum.</param>
        public void SetCustom3ColorScale(SLConditionalFormatMinMaxValues MinType, string MinValue,
            SLThemeColorIndexValues MinColor, double MinColorTint,
            SLConditionalFormatRangeValues MidPointType, string MidPointValue, Color MidPointColor,
            SLConditionalFormatMinMaxValues MaxType, string MaxValue, Color MaxColor)
        {
        ...
        public void SetIconSet(IconSetValues IconSetType)
        {
            switch (IconSetType)
            {
                case IconSetValues.FiveArrows:
                    SetCustomIconSet(new SLFiveIconSetOptions(SLFiveIconSetValues.FiveArrows));
                    break;
                case IconSetValues.FiveArrowsGray:
                    SetCustomIconSet(new SLFiveIconSetOptions(SLFiveIconSetValues.FiveArrowsGray));
                    break;
                case IconSetValues.FiveQuarters:
                    SetCustomIconSet(new SLFiveIconSetOptions(SLFiveIconSetValues.FiveQuarters));
                    break;
                case IconSetValues.FiveRating:
                    SetCustomIconSet(new SLFiveIconSetOptions(SLFiveIconSetValues.FiveRating));
                    break;
                case IconSetValues.FourArrows:
                    SetCustomIconSet(new SLFourIconSetOptions(SLFourIconSetValues.FourArrows));
                    break;
                case IconSetValues.FourArrowsGray:
                    SetCustomIconSet(new SLFourIconSetOptions(SLFourIconSetValues.FourArrowsGray));
                    break;
                case IconSetValues.FourRating:
                    SetCustomIconSet(new SLFourIconSetOptions(SLFourIconSetValues.FourRating));
                    break;
                case IconSetValues.FourRedToBlack:
                    SetCustomIconSet(new SLFourIconSetOptions(SLFourIconSetValues.FourRedToBlack));
                    break;
                case IconSetValues.FourTrafficLights:
                    SetCustomIconSet(new SLFourIconSetOptions(SLFourIconSetValues.FourTrafficLights));
                    break;
                case IconSetValues.ThreeArrows:
                    SetCustomIconSet(new SLThreeIconSetOptions(SLThreeIconSetValues.ThreeArrows));
                    break;
                case IconSetValues.ThreeArrowsGray:
                    SetCustomIconSet(new SLThreeIconSetOptions(SLThreeIconSetValues.ThreeArrowsGray));
                    break;
                case IconSetValues.ThreeFlags:
                    SetCustomIconSet(new SLThreeIconSetOptions(SLThreeIconSetValues.ThreeFlags));
                    break;
                case IconSetValues.ThreeSigns:
                    SetCustomIconSet(new SLThreeIconSetOptions(SLThreeIconSetValues.ThreeSigns));
                    break;
                case IconSetValues.ThreeSymbols:
                    SetCustomIconSet(new SLThreeIconSetOptions(SLThreeIconSetValues.ThreeSymbols));
                    break;
                case IconSetValues.ThreeSymbols2:
                    SetCustomIconSet(new SLThreeIconSetOptions(SLThreeIconSetValues.ThreeSymbols2));
                    break;
                case IconSetValues.ThreeTrafficLights1:
                    SetCustomIconSet(new SLThreeIconSetOptions(SLThreeIconSetValues.ThreeTrafficLights1));
                    break;
                case IconSetValues.ThreeTrafficLights2:
                    SetCustomIconSet(new SLThreeIconSetOptions(SLThreeIconSetValues.ThreeTrafficLights2));
                    break;
            }
        }
        ...
        /// <param name="GreaterThanOrEqual2">
        ///     True if values are to be greater than or equal to the 2nd range value. False if
        ///     values are to be strictly greater than.
        /// </param>
        /// <param name="Value2">The 2nd range value.</param>
        /// <param name="Type2">The conditional format type for the 2nd range value.</param>
        /// <param name="GreaterThanOrEqual3">
        ///     True if values are to be greater than or equal to the 3rd range value. False if
        ///     values are to be strictly greater than.
        /// </param>
        ...
        {
            var Options = new SLThreeIconSetOptions(IconSetType);
        ...
        /// <param name="Value3">The 3rd range value.</param>
        /// <param name="Type3">The conditional format type for the 3rd range value.</param>
        /// <param name="GreaterThanOrEqual4">
        ///     True if values are to be greater than or equal to the 4th range value. False if
        ///     values are to be strictly greater than.
        /// </param>
        ...
        {
            var Options = new SLFourIconSetOptions(IconSetType);
            Options.ReverseIconOrder = ReverseIconOrder;
            Options.ShowIconOnly = ShowIconOnly;
        ...
        /// <param name="Value4">The 4th range value.</param>
        /// <param name="Type4">The conditional format type for the 4th range value.</param>
        /// <param name="GreaterThanOrEqual5">
        ///     True if values are to be greater than or equal to the 5th range value. False if
        ///     values are to be strictly greater than.
        /// </param>
        ...
        {
            var Options = new SLFiveIconSetOptions(IconSetType);
            Options.ReverseIconOrder = ReverseIconOrder;
            Options.ShowIconOnly = ShowIconOnly;
        ...
        public void SetCustomIconSet(SLThreeIconSetOptions Options)
        {
            ...
            {
                var istv = X14.IconSetTypeValues.ThreeTrafficLights1;
                uint iIconId = 0;
            ...
            cfvo = new SLConditionalFormatValueObject();
            cfvo.Type = TranslateRangeValues(Options.Type2);
            cfvo.Val = Options.Value2;
            cfvo.GreaterThanOrEqual = Options.GreaterThanOrEqual2;
            cfr.IconSet.Cfvos.Add(cfvo);

            cfvo = new SLConditionalFormatValueObject();
            cfvo.Type = TranslateRangeValues(Options.Type3);
        ...
        public void SetCustomIconSet(SLFourIconSetOptions Options)
        {
            ...
            cfvo = new SLConditionalFormatValueObject();
            cfvo.Type = TranslateRangeValues(Options.Type4);
        ...
        public void SetCustomIconSet(SLFiveIconSetOptions Options)
        {
            ...
            cfvo = new SLConditionalFormatValueObject();
            cfvo.Type = TranslateRangeValues(Options.Type5);
        ...
        public void HighlightCellsGreaterThan(bool IncludeEquality, string Value,
            SLHighlightCellsStyleValues HighlightStyle)
        {
            HighlightCellsGreaterThan(IncludeEquality, Value, TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        /// <param name="IncludeEquality">True for greater than or equal to. False for strictly greater than.</param>
        /// <param name="Value">The value to be compared with.</param>
        /// <param name="HighlightStyle">
        ///     A custom formatted style. Note that only number formats, fonts, borders and fills are
        ///     used. Note further that for fonts, only italic/bold, underline, color and strikethrough settings are used.
        /// </param>
        ...
        private void HighlightCellsGreaterThan(bool IncludeEquality, string Value, SLDifferentialFormat HighlightStyle)
        {
            ...
            cfr.Formulas.Add(GetFormulaFromText(Value));
        ...
        /// <param name="Value">The value to be compared with.</param>
        /// <param name="HighlightStyle">A built-in highlight style.</param>
        public void HighlightCellsLessThan(bool IncludeEquality, string Value,
            SLHighlightCellsStyleValues HighlightStyle)
        {
            HighlightCellsLessThan(IncludeEquality, Value, TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        /// <param name="HighlightStyle">A built-in highlight style.</param>
        public void HighlightCellsBetween(bool IsBetween, string Value1, string Value2,
            SLHighlightCellsStyleValues HighlightStyle)
        {
            HighlightCellsBetween(IsBetween, Value1, Value2, TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        private void HighlightCellsBetween(bool IsBetween, string Value1, string Value2,
            SLDifferentialFormat HighlightStyle)
        {
            var cfr = new SLConditionalFormattingRule();
            cfr.Type = ConditionalFormatValues.CellIs;
            cfr.Operator = IsBetween
                ? ConditionalFormattingOperatorValues.Between
                : ConditionalFormattingOperatorValues.NotBetween;
            cfr.HasOperator = true;

            cfr.Formulas.Add(GetFormulaFromText(Value1));
            cfr.Formulas.Add(GetFormulaFromText(Value2));
        ...
        {
            HighlightCellsEqual(IsEqual, Value, TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        /// <param name="Value">The value to be compared with.</param>
        /// <param name="HighlightStyle">A built-in highlight style.</param>
        public void HighlightCellsContainingText(bool IsContaining, string Value,
            SLHighlightCellsStyleValues HighlightStyle)
        {
            HighlightCellsContainingText(IsContaining, Value, TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        private void HighlightCellsContainingText(bool IsContaining, string Value, SLDifferentialFormat HighlightStyle)
        {
            ...
            if (SequenceOfReferences.Count > 0)
                sRef = SLTool.ToCellReference(SequenceOfReferences[0].StartRowIndex,
                    SequenceOfReferences[0].StartColumnIndex);
            if (IsContaining)
            {
                cfr.Type = ConditionalFormatValues.ContainsText;
                cfr.Operator = ConditionalFormattingOperatorValues.ContainsText;
                cfr.HasOperator = true;
                f.Text = string.Format("NOT(ISERROR(SEARCH({0},{1})))", GetCleanedStringFromText(Value), sRef);
            }
            else
            {
                ...
                cfr.HasOperator = true;
                f.Text = string.Format("ISERROR(SEARCH({0},{1}))", GetCleanedStringFromText(Value), sRef);
            }
            cfr.Formulas.Add(f);
        ...
        {
            HighlightCellsBeginningWith(Value, TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        private void HighlightCellsBeginningWith(string Value, SLDifferentialFormat HighlightStyle)
        {
            ...
            cfr.HasOperator = true;
            f.Text = string.Format("LEFT({0},{1})={2}", sRef, Value.Length, GetCleanedStringFromText(Value));
            cfr.Formulas.Add(f);
        ...
        {
            HighlightCellsEndingWith(Value, TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        private void HighlightCellsEndingWith(string Value, SLDifferentialFormat HighlightStyle)
        {
            ...
            cfr.HasOperator = true;
            f.Text = string.Format("RIGHT({0},{1})={2}", sRef, Value.Length, GetCleanedStringFromText(Value));
            cfr.Formulas.Add(f);
        ...
        {
            HighlightCellsContainingBlanks(ContainsBlanks, TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        {
            HighlightCellsContainingErrors(ContainsErrors, TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        /// <param name="HighlightStyle">A built-in highlight style.</param>
        public void HighlightCellsWithDatesOccurring(TimePeriodValues DatePeriod,
            SLHighlightCellsStyleValues HighlightStyle)
        {
            HighlightCellsWithDatesOccurring(DatePeriod, TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        private void HighlightCellsWithDatesOccurring(TimePeriodValues DatePeriod, SLDifferentialFormat HighlightStyle)
        {
            ...
            switch (DatePeriod)
            {
                ...
                case TimePeriodValues.LastMonth:
                    f.Text =
                        string.Format("AND(MONTH({0})=MONTH(EDATE(TODAY(),0-1)),YEAR({0})=YEAR(EDATE(TODAY(),0-1)))",
                            sRef);
                    break;
        ...
        {
            HighlightCellsWithDuplicates(TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        {
            HighlightCellsWithUniques(TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        /// <param name="Rank">
        ///     The value of X in "Top/Bottom X". If <paramref name="IsPercent" /> is true, then X refers to X%,
        ///     otherwise it's X number of items.
        /// </param>
        /// <param name="IsPercent">True if referring to percentage. False if referring to number of items.</param>
        /// <param name="HighlightStyle">A built-in highlight style.</param>
        public void HighlightCellsInTopRange(bool IsTopRange, uint Rank, bool IsPercent,
            SLHighlightCellsStyleValues HighlightStyle)
        {
            HighlightCellsInTopRange(IsTopRange, Rank, IsPercent, TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        private void HighlightCellsInTopRange(bool IsTopRange, uint Rank, bool IsPercent,
            SLDifferentialFormat HighlightStyle)
        {
            var cfr = new SLConditionalFormattingRule();
        ...
        /// <param name="HighlightStyle">A built-in highlight style.</param>
        public void HighlightCellsAboveAverage(SLHighlightCellsAboveAverageValues AverageType,
            SLHighlightCellsStyleValues HighlightStyle)
        {
            HighlightCellsAboveAverage(AverageType, TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        private void HighlightCellsAboveAverage(SLHighlightCellsAboveAverageValues AverageType,
            SLDifferentialFormat HighlightStyle)
        {
            var cfr = new SLConditionalFormattingRule();
        ...
        {
            HighlightCellsWithFormula(Formula, TranslateToDifferentialFormat(HighlightStyle));
        }
        ...
        private void HighlightCellsWithFormula(string Formula, SLDifferentialFormat HighlightStyle)
        {
            ...
            cfr.Formulas.Add(new Formula(Formula));
            cfr.DifferentialFormat = HighlightStyle.Clone();
            cfr.HasDifferentialFormat = true;
        ...
        {
            var cfvov = ConditionalFormatValueObjectValues.Number;
            switch (RangeValue)
            {
                case SLConditionalFormatRangeValues.Number:
        ...
        {
            var result = SLConditionalFormatAutoMinMaxValues.Value;
            switch (MinMaxValue)
            {
                case SLConditionalFormatMinMaxValues.Formula:
        ...
        internal SLDifferentialFormat TranslateToDifferentialFormat(SLHighlightCellsStyleValues style)
        {
            ...
            switch (style)
            {
                case SLHighlightCellsStyleValues.LightRedFillWithDarkRedText:
                    ...
                    df.Font.FontColor = Color.FromArgb(0xFF, 0x9C, 0x00, 0x06);
                    df.Fill.SetPatternBackgroundColor(Color.FromArgb(0xFF, 0xFF, 0xC7, 0xCE));
                    break;
                case SLHighlightCellsStyleValues.YellowFillWithDarkYellowText:
                    df.Font.Condense = false;
                    df.Font.Extend = false;
                    df.Font.FontColor = Color.FromArgb(0xFF, 0x9C, 0x65, 0x00);
                    df.Fill.SetPatternBackgroundColor(Color.FromArgb(0xFF, 0xFF, 0xEB, 0x9C));
                    break;
                case SLHighlightCellsStyleValues.GreenFillWithDarkGreenText:
                    df.Font.Condense = false;
                    df.Font.Extend = false;
                    df.Font.FontColor = Color.FromArgb(0xFF, 0x00, 0x61, 0x00);
                    df.Fill.SetPatternBackgroundColor(Color.FromArgb(0xFF, 0xC6, 0xEF, 0xCE));
                    break;
                ...
                case SLHighlightCellsStyleValues.RedBorder:
                    df.Border.SetLeftBorder(BorderStyleValues.Thin, Color.FromArgb(0xFF, 0x9C, 0x00, 0x06));
                    df.Border.SetRightBorder(BorderStyleValues.Thin, Color.FromArgb(0xFF, 0x9C, 0x00, 0x06));
                    df.Border.SetTopBorder(BorderStyleValues.Thin, Color.FromArgb(0xFF, 0x9C, 0x00, 0x06));
                    df.Border.SetBottomBorder(BorderStyleValues.Thin, Color.FromArgb(0xFF, 0x9C, 0x00, 0x06));
                    break;
            }
        ...
        internal void FromConditionalFormatting(ConditionalFormatting cf)
        {
            ...
            if (cf.SequenceOfReferences != null)
                SequenceOfReferences = SLTool.TranslateSeqRefToCellPointRange(cf.SequenceOfReferences);
        ...
        internal ConditionalFormatting ToConditionalFormatting()
        {
            ...
            cf.SequenceOfReferences = SLTool.TranslateCellPointRangeToSeqRef(SequenceOfReferences);

            foreach (var cfr in Rules)
        ...
        {
            var cf = new SLConditionalFormatting();
            ...
            for (i = 0; i < SequenceOfReferences.Count; ++i)
            {
                cpr = new SLCellPointRange(SequenceOfReferences[i].StartRowIndex,
                    SequenceOfReferences[i].StartColumnIndex, SequenceOfReferences[i].EndRowIndex,
                    SequenceOfReferences[i].EndColumnIndex);
