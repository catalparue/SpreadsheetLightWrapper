...
namespace Ups.Toolkit.SpreadsheetLight.Core
{
    public partial class SLDocument
    {
        ...
        {
            return GetWidth(Unit, ColumnIndex, ColumnIndex);
        }
        ...
        public double GetWidth(SLMeasureUnitTypeValues Unit, int StartColumnIndex, int EndColumnIndex)
        {
            ...
            switch (Unit)
            {
                case SLMeasureUnitTypeValues.Centimeter:
                    result = SLConvert.FromEmuToCentimeter(lWidth);
                    break;
                case SLMeasureUnitTypeValues.Emu:
                    result = lWidth;
                    break;
                case SLMeasureUnitTypeValues.Inch:
                    result = SLConvert.FromEmuToInch(lWidth);
                    break;
                case SLMeasureUnitTypeValues.Point:
                    result = SLConvert.FromEmuToPoint(lWidth);
                    break;
            }
        ...
        {
            return GetHeight(Unit, RowIndex, RowIndex);
        }
        ...
        public double GetHeight(SLMeasureUnitTypeValues Unit, int StartRowIndex, int EndRowIndex)
        {
            ...
            {
                case SLMeasureUnitTypeValues.Centimeter:
                    result = SLConvert.FromEmuToCentimeter(lHeight);
                    break;
                case SLMeasureUnitTypeValues.Emu:
                    result = lHeight;
                    break;
                case SLMeasureUnitTypeValues.Inch:
                    result = SLConvert.FromEmuToInch(lHeight);
                    break;
                case SLMeasureUnitTypeValues.Point:
                    result = SLConvert.FromEmuToPoint(lHeight);
                    break;
            }
        ...
        /// </summary>
        /// <param name="Name">SheetName of defined name to check.</param>
        ...
        /// </summary>
        /// <param name="Name">SheetName of existing defined name.</param>
        ...
        /// <param name="Name">SheetName of existing defined name.</param>
        /// <returns>
        ///     The comment of the defined name. An empty string is returned if the given defined name doesn't exist, or
        ///     there's no comment.
        /// </returns>
        ...
        {
            var result = new List<SLDefinedName>();
        ...
        /// <summary>
        ///     Set the print area on the currently selected worksheet given a corner cell of the print area and the opposite
        ///     corner cell.
        /// </summary>
        ...
        public void SetPrintArea(string StartCellReference, string EndCellReference)
        {
            ...
            SetAddPrintArea(iStartRowIndex, iStartColumnIndex, iEndRowIndex, iEndColumnIndex, false);
        }
        ...
        {
            SetAddPrintArea(StartRowIndex, StartColumnIndex, EndRowIndex, EndColumnIndex, false);
        }
        ...
        {
            SetAddPrintArea(StartRowIndex, StartColumnIndex, EndRowIndex, EndColumnIndex, true);
        }
        ...
        /// <summary>
        ///     Refresh pivot table data on load or open of spreadsheet. This applies to all pivot tables on the currently selected
        ///     worksheet.
        /// </summary>
