...
namespace Ups.Toolkit.SpreadsheetLight.Core.Drawing
{
    internal class SLDrawingTool
    {
        ...
        {
            var theme = SLThemeColorIndexValues.Dark1Color;
        ...
        internal static long CalculateCoordinate(decimal PointLength)
        {
            ...
            return Convert.ToInt64(PointLength*SLConstants.PointToEMU);
        }
        ...
        {
            var iAngle = Convert.ToInt32(Angle*SLConstants.DegreeToAngleRepresentation);
        ...
        internal static int CalculateFovAngle(decimal Angle)
        {
            ...
            return Convert.ToInt32(Angle*SLConstants.DegreeToAngleRepresentation);
        }
