...
namespace Ups.Toolkit.SpreadsheetLight.Core
{
    public partial class SLDocument
    {
        ...
        /// <param name="SortAscending">True to sort in ascending order. False to sort in descending order.</param>
        public void Sort(int StartRowIndex, int StartColumnIndex, int EndRowIndex, int EndColumnIndex,
            int SortByColumnIndex, bool SortAscending)
        {
            Sort(StartRowIndex, StartColumnIndex, EndRowIndex, EndColumnIndex, true, SortByColumnIndex, SortAscending);
        }
